...
.addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=876027065646866492&scope=bot&permissions=10468991038)` + "** | **" + `[Destek Sunucusu](https://discord.gg/PPH44U8k4g)`  + "»Komutlar» .sunucu-kur,.ping(.ms),.hava,.yapımcım,.bot-kontrol,.kullanıcı-bilgi,.sunucu-bilgi,.kurallar|TRjudl  " + ``  + "** | **" + `  `, false)
...
.addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=876027065646866492&scope=bot&permissions=10468991038)` + "** | **" + `[Destek Sunucusu](https://discord.gg/PPH44U8k4g)`  + "  " + ``  + "** | **" + `  `, false)
...
.addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=876027065646866492&scope=bot&permissions=10468991038)` + "** | **" + `[Destek Sunucusu](https://discord.gg/PPH44U8k4g)`  + "»komutlar».adamasmaca».zar-at».stresçarkı».kaçcm».espri».aşkımı-ölç».ara155».ship|TRjudl " + ``  + "** | **" + `  `, false)
...
.addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=876027065646866492&scope=bot&permissions=10468991038)` + "** | **" + `[Destek Sunucusu](https://discord.gg/PPH44U8k4g)`  + "»komutlar».yardım,.ban,.unban,.ban-log,.istatistik,.sunucu-bilgi  " + ``  + "** | **" + `  `, false)
...
//YARDIM KOMUTU
  ...
  **[${prefix}yardım Genel](TRjudl)** 
  **[${prefix}yardım Eğlence](TRjudl)**
  **[${prefix}yardım Moderasyon](TRjudl)**
  **[${prefix}yardım Sunucu](TRjudl)**
  **[${prefix}yardım Sahip](TRjudl)**
  `)
  .addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=876027065646866492&scope=bot&permissions=10468991038)` + "** | **" + `[Destek Sunucusu](https://discord.gg/PPH44U8k4g)`  + "  " + ``  + "** ☾☆ TRjudl ☾☆ **" + `  `, false)
